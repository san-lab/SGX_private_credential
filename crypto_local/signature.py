...
# ----------------------------------------------------------------------------------------------
    def encrypt_data(self, data, encryption_key, iv):
        encript = encAlgorithm()
        return encript.encrypt_data(data, encryption_key, iv)
...
#---------------------------------------------------------------------------------------------
    def generate_client_signature(self, input_json_str,
        ...
        input_json_params['requesterNonce'] = uuid.uuid4().hex[:32]
...
#---------------------------------------------------------------------------------------------
    def random_bit_string(self, length): ##DONE
        list = []
...
# ----------------------------------------------------------------------------------------------
    def generate_sessioniv(self): ## DONE
        return self.random_bit_string(12)

# ----------------------------------------------------------------------------------------------
    def generate_encrypted_session_key(self, session_key, worker_encryption_key): ## DONE
        session_key = encAlgorithm()
...
#---------------------------------------------------------------------------------------------
    ...
    def generate_encripted_key(self, session_key,encription_key):

        key = RSA.importKey(encription_key)
